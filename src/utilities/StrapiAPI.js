...
export const StrapiAPI = async (
  ...
  const PROXY_API_URL =
    "https://corsproxy.io/?" +
    encodeURIComponent(`http://54.242.213.239:1337/api/value-sets?filters[$and][0][valuesetkey][$eq]=${strapikey}&filters[$and][1][organization][$eq]=${org}&fields[0]=code&fields[1]=display&fields[2]=definition&fields[2]=valuesetkey&filters[$and][2][version][$eq]=${version}`);
  const API_KEY =
